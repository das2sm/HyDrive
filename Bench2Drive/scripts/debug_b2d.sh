...
BASE_TM_PORT=5001
IS_BENCH2DRIVE=True
BASE_ROUTES=$F2D_DIR/fail2drive_split/${1:-Generalization_Animals_1082}
...
SAVE_NAME=${1:-Generalization_Animals_1082}
TEAM_CONFIG=projects/configs/sparsedrive_stage2.py+ckpt/sparsedrive_small_b2d_stage2.pth+${SAVE_NAME}
